...
vi.mock('@/form-builder/components/fields/CheckboxFieldEditor', () => ({
  CheckboxFieldEditor: vi.fn(),
}))
vi.mock('@/form-builder/components/fields/ConsentFieldEditor', () => ({
  ConsentFieldEditor: vi.fn(),
}))
...
vi.mock('@/form-builder/components/fields/MessageFieldEditor', () => ({
  MessageFieldEditor: vi.fn(),
}))
vi.mock('@/form-builder/components/fields/NumberFieldEditor', () => ({
  NumberFieldEditor: vi.fn(),
}))
vi.mock('@/form-builder/components/fields/RadioFieldEditor', () => ({ RadioFieldEditor: vi.fn() }))
vi.mock('@/form-builder/components/fields/SelectFieldEditor', () => ({
  SelectFieldEditor: vi.fn(),
}))
vi.mock('@/form-builder/components/fields/TextFieldEditor', () => ({ TextFieldEditor: vi.fn() }))
vi.mock('@/form-builder/components/fields/TextareaFieldEditor', () => ({
  TextareaFieldEditor: vi.fn(),
}))
vi.mock('@/form-builder/components/fields/ToggleFieldEditor', () => ({
  ToggleFieldEditor: vi.fn(),
}))
