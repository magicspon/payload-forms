...
export function FormFieldsProvider({ children }: { children: React.ReactNode }) {
	const [selectedFieldMeta, setSelectedFieldMetaState] =
		React.useState<null | SelectedFieldMeta>(null)
	...
	const setSelectedField = React.useCallback(
		(field: Field | null) =>
			setSelectedFieldMeta(field ? { field, pageId: '', rowId: '' } : null),
	...
	const value = React.useMemo(
		...
		[clearSelectedField, editorDrawerSlug, selectedFieldMeta, setSelectedField, setSelectedFieldMeta],
	)
