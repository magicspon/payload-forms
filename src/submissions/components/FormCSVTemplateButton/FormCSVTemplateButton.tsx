...
export function FormCSVTemplateButton() {
  ...
  const pages = (data as Record<string, unknown> | undefined)?.pages as undefined | unknown[]

  const slug = ((data as Record<string, unknown> | undefined)?.slug as string | undefined) ?? 'form'
