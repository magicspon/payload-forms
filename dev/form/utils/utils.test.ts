...
import { buildValidatorCache, errorsToProps, getDefaultValues, isVisible, makeValidator } from '.'
...
describe('errorsToProps', () => {
  ...
  it('deduplicates identical errors', () => {
    expect(errorsToProps(['Required', 'Required'])).toEqual([{ message: 'Required' }])
  })
  ...
  it('extracts message from error objects', () => {
    expect(errorsToProps([{ message: 'Invalid format' }])).toEqual([{ message: 'Invalid format' }])
  })
