...
function InputGroupButton({
  ...
  return <button type={type} data-size={size} className={cn(styles.button, className)} {...props} />
}
...
function InputGroupInput({ className, ...props }: React.ComponentProps<'input'>) {
  return (
    <Input data-slot="input-group-control" className={cn(styles.input, className)} {...props} />
  )
}
